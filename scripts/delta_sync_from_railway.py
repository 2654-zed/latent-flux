...
TABLES = [
    # High-volume event streams (id-cursored, IGNORE on duplicate id)
    ...
    ("timelock_countdowns",       "id", "id", ["id"], "IGNORE"),
    ("sload_patterns",            "id", "id", ["id"], "IGNORE"),
    ...
    ("predictions",               "id", "id", ["id"], "IGNORE"),
    ("drain_values",              "id", "id", ["id"], "IGNORE"),
    ("bot_sophistication",        "id", "id", ["id"], "IGNORE"),

    # Cluster / analysis outputs (small, REPLACE for latest)
    ...
    ("detector_precision",        "id", "id", ["id"], "REPLACE"),
    ("bot_strategies",            "id", "id", ["id"], "REPLACE"),

    # PK-cursored (string PK; use timestamp col as cursor, REPLACE on PK)
