...
- "Confirmed-tier: 1,650 adversarial contracts" (corpus headline, retired 2026-05-22 — see Correction #25). **Post-Phase-A-migration count is 1,535.** 116 of 1,650 (7.2%) were verified-source legitimate ERC-20 tokens (including Circle Wrapped Bitcoin, TetherGold, Hyperliquid, Backpack, Mezo, Gensyn). Subject to further refinement after Phase B+C audit of remaining NEEDS_REVIEW (1,420) and EDGE (64) populations — the final number may move further. **Camouflage Ratio confirmed-tier 30.44% (Correction #22) also pending recompute against the post-migration corpus.**
