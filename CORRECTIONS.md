...
| org_001 is a "$285M+ criminal organization" / extraction scale | 2026-06-08 | org_001's traced extraction is **~$257K** (monitored-L2 cycles EXTRACTION_001–003, themselves unverified). The $285M (Drift Protocol governance hack, **Solana**, **DPRK**-attributed), $18.4M (Rhea, **NEAR**), and $5M (Wasabi) were **external incidents on unmonitored chains** swept into org_001 by a `SUM ... WHERE event_id LIKE 'EXTRACTION_00%'` query bug. Of 6,842 org_001 contracts, **1** drains anyone (verified 266-drain set) and **0** of its 1,445 deployers are real drainers; the "18 confirmed" core includes **3 verified Chainlink oracles** + bait/behavioral FPs (~1 genuinely adversarial). org_001 is a funding-chain/infrastructure cluster, not a coordinated org. | "org_001 Is Not a $285M Criminal Organization" — `reports/correction_log.md` Correction #30 (2026-06-08) |
| Drain/victim headline counts (3,437 lifetime; and a briefly-reported 44,540) | 2026-06-07 | **266 confirmed real approval-drains** (~325 projected) / 259 victims / 104 drainers, every row on-chain-attributed via the tx-initiator test. The 3,437 was Bug #19b-inflated + tx_events-blind; the 44,540 was the `n_out>0` method counting ~98% legitimate DEX sales as drains. | "n_out>0 counted DEX sales as drains" — `reports/correction_log.md` Correction #29 (2026-06-07/08) |
