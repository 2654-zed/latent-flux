...
| "Confirmed-tier: 1,650 adversarial contracts" (corpus headline) | 2026-05-22 | **1,534** after Phase A audit migration. **116 of 1,650 (7.2%) were verified-source legitimate ERC-20 tokens** misclassified as adversarial, including **Circle Wrapped Bitcoin (119K holders)**, **TetherGold (229K holders)**, **Hyperliquid (129K holders)**, **Backpack (113K holders)**, **Mezo (142K holders)**, **Gensyn (196K holders)**. Caused by three stacked classifier bugs (bytecode FP on framework patterns, behavioral FP on pre-launch bot reverts, no Blockscout-verified gate at promotion time). Post-migration count subject to further refinement after Phase B+C audit of remaining NEEDS_REVIEW (1,420) and EDGE (64) sub-populations. See `reports/correction_log.md` Correction #25 + `reports/confirmed_tier_audit_2026-05-22.csv`. | "Confirmed-Tier Audit Phase A" (2026-05-22) |
...
- **Severity:** HIGH. 7.2% FP rate is large enough that the headline "confirmed-tier" count cannot be reused at face value across prior materials. Multiple individual findings (Circle Wrapped Bitcoin, TetherGold, Hyperliquid) are credibility-critical — if any deck or report cited a count that included these, the claim is directly disprovable.
